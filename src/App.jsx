          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              <div><label className="text-sm font-medium text-slate-600 mb-1 block">Ton CV</label>
                <textarea value={cv} onChange={(e) => setCv(e.target.value)} rows={10} placeholder="Colle ton CV ici…" className="w-full p-3 rounded-lg border border-slate-200 bg-white text-sm outline-none focus:border-indigo-400 resize-none" /></div>
